    ...
    vbox:
        ...
        hbox:
            ...
            textbutton ("ON" if getattr(store,'bloom_enabled', False) else "OFF"):
                action ToggleVariable("bloom_enabled")
        hbox:
            spacing 8
            text "Threshold" size 12 color "#cccccc" yalign 0.5 xsize 90
            bar value VariableValue("bloom_threshold", 1.0, offset=0.0) xsize 220 changed Function(renpy.restart_interaction)
        hbox:
            spacing 8
            text "Strength" size 12 color "#cccccc" yalign 0.5 xsize 90
            bar value VariableValue("bloom_strength", 2.0, offset=0.0) xsize 220 changed Function(renpy.restart_interaction)
        hbox:
            spacing 8
            text "Radius" size 12 color "#cccccc" yalign 0.5 xsize 90
            bar value VariableValue("bloom_radius", 8.0, offset=0.0) xsize 220 changed Function(renpy.restart_interaction)
        null height 8
...
screen lighting_editor():
    if lighting_editor_open:
        ...
        $ _title_sz = (22 if lighting_editor_compact else 24)
                ...
                hbox:
                    ...
                    frame:
                        ...
                        vbox:
                            ...
                            hbox:
                                spacing 6
                                text "Lights" size 16 color "#ffffff" yalign 0.5
                                null width 6
                                textbutton "+Add":
                            ...
                            viewport:
                                ...
                                vbox:
                                    ...
                                    if not _dl:
                                        text "(no lights)" size 12 color "#999999"
                    ...
                    frame:
                        ...
                        vbox:
                            spacing _sp
                            text "Canvas" size 14 color "#dddddd"
                    ...
                    frame:
                        ...
                        viewport:
                            ...
                            vbox:
                                spacing _sp
                                text "Properties" size 16 color "#ffffff"
