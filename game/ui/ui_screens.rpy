...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            # Skip button removed - skipping disabled globally
...
# Default quick_menu to True so the quick menu is shown by default
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Options")
                    # Skip preferences removed - skipping disabled globally
...
################################################################################
## Global Shader Preset Menu Integration
################################################################################

# Shader preset menu system is loaded automatically via overlay_screens
# in ui_shader_preset_menu.rpy - F9 hotkey available globally
